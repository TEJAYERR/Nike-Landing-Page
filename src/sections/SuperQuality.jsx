...
export const SuperQuality = () => {
    return(
        <div className="flex items-center gap-10 justify-between text-lg max-lg:flex-col">
            <div className="min-lg:w-[45%] flex flex-col items-start">
                <h1 className="text-5xl font-semibold max-sm:text-[2rem]">We Provide You <span className="text-red-400">Super Quality</span> Shoes</h1>
