    ...
    return(
        <div className="flex-1 flex justify-center items-center gap-10 max-xl:flex-col-reverse">
            ...
            <div className="flex-1 flex flex-col text-lg max-xl:w-[50%] max-lg:w-[100%]">
                ...
                <div className="mt-8 flex-1 flex items-center gap-5 justify-start">
                    <button className="flex gap-3 px-10 py-3 bg-red-400 text-white rounded-4xl cursor-pointer">Shop now <img src={arrowRight} alt="" width={25}/></button>
                    <button className="px-10 py-3 bg-white border rounded-4xl text-gray-600 cursor-pointer">Learn more</button>
                </div>
            </div>
        </div>
    );
