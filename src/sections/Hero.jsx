        ...
        <div>
            <div id='home' className='w-full flex-1 flex items-center justify-around gap-5 max-xl:flex-col max-xl:items-start max-xl:justify-center'> 
                <div className='bg-white pl-15 max-xl:pr-[90px] max-sm:px-5'>
                    ...
                    <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[2rem] max-md:text-6xl font-bold">The New Arrival</h1>
                    <h1 className="text-8xl mt-3 font-medium max-sm:text-[2rem] max-md:text-6xl"><b className="text-red-400">Nike</b> Shoes</h1>
